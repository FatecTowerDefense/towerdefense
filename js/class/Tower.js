...
var Tower = function (xTile, yTile, fireOffsetX, fireOffsetY, sprite, damage, range, fireRate,
					   health, imortal, bulletSpeed, price, bulletSprite) {
		...
		//valores incrementados as coordenadas do centro do tile
		//usados para alterar o ponto de onde a bala sai
		this.tower.fireOffsetX = fireOffsetX;
		this.tower.fireOffsetY = fireOffsetY;
